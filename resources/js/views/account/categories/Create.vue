<template>
    <h1 class="text-3xl mb-3">Add category</h1>
    ...
    <div class="relative overflow-x-auto p-6 bg-white">
        ...
        <form @submit.prevent="storeCategory(category)" class="w-full lg:w-3/4">
            <!-- Title -->
            <div>
                <label for="category-name" class="block text-sm font-medium text-gray-700">
                    Name
                </label>
                <input v-model="category.name" id="category-name" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
...
const { storeCategory, actionErrors, validationErrors, isLoading } = useCategories();
