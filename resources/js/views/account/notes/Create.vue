<template>
    <h1 class="text-3xl mb-3">Add note</h1>
    ...
    <div class="relative overflow-x-auto p-6 bg-white">
        ...
        <form @submit.prevent="storeNote(note)" class="w-full lg:w-3/4">
            <!-- Title -->
            <div>
                <label for="post-title" class="block text-sm font-medium text-gray-700">
                    Title
                </label>
                <input v-model="note.title" id="post-title" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
            ...
            <div class="mt-4">
                ...
                <textarea v-model="note.content" id="post-content" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"></textarea>
                <div class="text-red-600 mt-1">
            ...
            <div class="mt-4">
                ...
                <select v-model="note.category_id" id="post-category" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
...
const { storeNote, actionErrors, validationErrors, isLoading } = useNotes();
