<template>
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex justify-start items-center">
                    ...
                    <router-link :to="{ name: 'home' }" class="flex items-center justify-between mr-4">
                        <img
                            src="@/assets/logo.svg"
                            class="mr-3 h-8"
                            alt="Website Logo"
        ...
        <aside
            ...
            <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <router-link
                            :to="{ name: 'account.categories.index' }"
                            class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                            >
                            <svg
                                aria-hidden="true"
        ...
        <main class="p-4 md:ml-64 h-auto max-[435px]:pt-28 pt-20">
...
<script setup>
    ...
    const toggleSidebar = () => {
        basicStore.hiddenSidebar = !basicStoreInfo.hiddenSidebar;
    }
